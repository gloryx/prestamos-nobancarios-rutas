...
type Props = { label: string; required?: boolean; file?: File; onChange: (file?: File) => void };
export function CompactImageUploader({ label, required, file, onChange }: Props): ReactElement {
